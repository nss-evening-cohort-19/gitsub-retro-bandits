...
const navBar = () => {
  ...
  <span class="iconify-inline" data-icon="akar-icons:book"></span>
  <a href="../index.html" id="Overview" class="btn navi-btn" type="button">Overview</a>
  <span class="iconify-inline" data-icon="octicon:repo-24"></span>
  <a href="../repos.html" id="Repos" class="btn navi-btn" type="button">Repositories</a>
  <span class="iconify-inline" data-icon="octicon:table-24"></span>
  <a href="../projects.html" id="projects" class="btn navi-btn" type="button">Projects</a>
  <span class="iconify-inline" data-icon="octicon:package-24"></span>
